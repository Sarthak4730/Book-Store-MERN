const BelowNavbar = () => {
  return (
    <div className='w-[70vw] h-[50vh] mx-auto mt-10 flex'>
      ...
      <div className="right w-[40vw] flex justify-center items-center relative">
        ...
        <img className="h-[35vh] z-2 absolute left-[18vw]" src="belowNavbarThreeBooks/second.png" alt="second" />
        <img className="h-[30vh] z-1 absolute left-[24vw]" src="belowNavbarThreeBooks/third.png" alt="third" />
      </div>
    </div>
  )
}
