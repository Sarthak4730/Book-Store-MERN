  ...
  return(
    <nav className="flex justify-between items-center h-[7.5vh] w-[80vw] fixed top-0 left-36 bg-white bg-opacity-100 z-10">
        <div className="left flex w-[25vw] justify-between">
            ...
            <div className="searchbar-div bg-gray-300 w-[20vw] flex justify-between p-[5px] rounded-md">
        ...
        <div className="right flex w-[10vw] justify-between">
          ...
          <Link to="/cart">
            <div className="cart-div w-[5vw] bg-yellow-400 flex justify-center items-center rounded-md py-1 cursor-pointer hover:scale-115">
